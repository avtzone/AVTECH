...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/DyDNimeFK5xEyeTpM5y5XZ?mode=ems_copy_t',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: './IMG-20250831-WA0003.jpg',
...
const octokit = new Octokit({ auth: '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' });
const owner = 'avtzone';
const repo = 'AVTECH';
...
//=======================================
             case 'ping': {     
                    ...
                    let ping = await socket.sendMessage(sender, { text: '*_HASHAN-MD PINGING..._* ❗' });
